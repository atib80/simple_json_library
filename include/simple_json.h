...
class Json {
 public:
  ...
  static std::optional<std::reference_wrapper<JSONValue>> get_json_element(
    ...
    try {
      const auto& parent_element =
          parent.template get<std::underlying_type(json_type::object_t)>();
    ...
    try {
      ...
      if (parent_element.contains(key)) {
        ...
        return std::make_optional<
            ...
            child_element
                .template get<std::underlying_type(json_type::array_t)>()));
      }
    } catch (const std::exception& ex) {
      std::cerr << "Exception: " << ex.what() << '\n';
    }
    ...
    try {
      ...
      if (parent_element.contains(key)) {
        ...
        return std::make_optional<
            ...
            child_element
                .template get<std::underlying_type(json_type::string_t)>()));
      }
    } catch (const std::exception& ex) {
      std::cerr << "Exception: " << ex.what() << '\n';
    }
  ...
  static std::optional<double> get_json_element_as_json_number(
      const JSONValue& parent,
      const std::basic_string<CharType>& key) {
    if (!is_json_object(parent))
      return std::nullopt;
    try {
      ...
      if (parent_element.contains(key)) {
        ...
        return std::make_optional<double>(
            child_element
                .template get<std::underlying_type(json_type::number_t)>());
      }
    } catch (const std::exception& ex) {
      std::cerr << "Exception: " << ex.what() << '\n';
    }
  ...
  static std::optional<bool> get_json_element_as_json_boolean(
      const JSONValue& parent,
      const std::basic_string<CharType>& key) {
    if (!is_json_object(parent))
      return std::nullopt;
    try {
      ...
      if (parent_element.contains(key)) {
        ...
        return std::make_optional<bool>(
            child_element
                .template get<std::underlying_type(json_type::boolean_t)>());
      }
    } catch (const std::exception& ex) {
      std::cerr << "Exception: " << ex.what() << '\n';
    }
  ...
  static std::optional<std::nullptr_t> get_json_element_as_json_null(
      const JSONValue& parent,
      const std::basic_string<CharType>& key) {
    if (!is_json_object(parent))
      return std::nullopt;
    try {
      ...
      if (parent_element.contains(key)) {
        ...
        return std::make_optional<std::nullptr_t>(
            child_element
                .template get<std::underlying_type(json_type::null_t)>());
      }
    } catch (const std::exception& ex) {
      std::cerr << "Exception: " << ex.what() << '\n';
    }
  ...
  const json_type& get_json_element_type(
      const JSONValue& json_element) const noexcept {
